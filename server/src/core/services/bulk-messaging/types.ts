...
export interface IBulkMessageService {
    ...
    previewMessage(args: BulkMessagePreviewArgs): Promise<BulkMessagePreviewResult>;
}
...
export interface BulkMessagePreviewArgs {
    message: string;
    subject?: string;
}

export interface BulkMessagePreviewResult {
    message: string;
    subject: string;
}
